...
public class UpUsers extends javax.swing.JPanel {
    ...
    private void InitStyles( ){
       ...
       nameTxt.putClientProperty("JTextField.placeholderText", "Ingrese el nombre de usuario.");
       apPTxt.putClientProperty("JTextField.placeholderText", "Ingrese primer apellido.");
       apMTxt.putClientProperty("JTextField.placeholderText", "Ingrese segundo apellido.");
       domTxt.putClientProperty("JTextField.placeholderText", "Ingrese la direccion del usuario.");
    ...
    private void initComponents() {
        ...
        apPLbl.setText("Primer Apellido");

        apMLbl.setText("Segundo Apellido");
    ...
    private void buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionPerformed
        String nombre = nameTxt.getText();  //a base de esto haremos las validaciones de abajo
        ...
        if(nombre.isEmpty() || apP.isEmpty() || dom.isEmpty() || tel.isEmpty()){
        ...
        Usersm user = isEdition ? userEdition : new Usersm();
        user.setName(nombre);
        ...
        try{
            ...
            String exitoso =  isEdition? "modificado": "registrado";
            
            JOptionPane.showMessageDialog(this,"Usuario" + exitoso+ "  correctamente. \n", "AVISO",JOptionPane.INFORMATION_MESSAGE);
